  ...
  const skillsData = [
    {
      ...
      description: "Strong foundation in DSA with C/C++. Problem-solving and competitive programming experience.",
      icon: <AlgorithmIcon />,
    ...
    },
    {
      ...
      description: "Modern web development with React, HTML5, CSS3, and JavaScript. Responsive design expertise.",
      icon: <WebIcon />,
    ...
    },
    {
      ...
      description: "Server-side development with Node.js, Express.js, and database management with MongoDB.",
      icon: <DatabaseIcon />,
    ...
    },
    {
      ...
      description: "Proficient with modern development tools, version control, and API testing platforms.",
      icon: <ToolIcon />,
                      ...
                      <Stack spacing={2} sx={{ height: '100%' }}>
                        ...
                        {skill.techIcons.length > 0 && (
                          <Box sx={{ display: 'flex', gap: 1, mt: 'auto' }}>
                            {skill.techIcons.slice(0, 4).map((IconComponent, iconIndex) => (
                              <Box
                                key={iconIndex}
                                sx={{
                                  width: 24,
